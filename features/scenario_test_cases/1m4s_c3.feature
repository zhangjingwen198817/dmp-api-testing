Feature: 1m4s_c3
  ...
  @case.1031 @version.09
  Scenario: 1031-config the MySQL group with SIP
    When I found 1m4s-C3 MySQL group with 5 MySQL instances,or I skip the test
  ...
  @case.1075 @version.09
  Scenario: 1075-config the MySQL instance with SIP
    When I found 1m4s-C3 MySQL group with 5 MySQL instances,or I skip the test
