Feature: 1m2s_b9
  ...
  @case.1040_1 @version.09
  Scenario: 1040_1-stop SLA policy
    When I found 1m2s-B9 MySQL group with 3 MySQL instances,or I skip the test
  ...
  @case.1040_2 @version.09
  Scenario: 1040_2-start SLA policy
    When I found 1m2s-B9 MySQL group with 3 MySQL instances,or I skip the test
  ...
  @case.1025 @version.09
  Scenario: 1025-config the MySQL group with SIP
    When I found 1m2s-B9 MySQL group with 3 MySQL instances,or I skip the test
  ...
  @case.1070 @version.09
  Scenario: 1070-config the MySQL instance with SIP
    When I found 1m2s-B9 MySQL group with 3 MySQL instances,or I skip the test
