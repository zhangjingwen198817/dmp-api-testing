Feature: 1m2s_b8
  ...
  @case.1024 @version.09
  Scenario: 1024-config the MySQL group with SIP
    When I found 1m2s-B8 MySQL group with 3 MySQL instances,or I skip the test
  ...
  @case.1069 @version.09
  Scenario: 1069-config the MySQL instance with SIP
    When I found 1m2s-B8 MySQL group with 3 MySQL instances,or I skip the test
